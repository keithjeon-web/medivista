...
<main>
    ...
    <div class="container">
      <div class="brand-hero-grid">
        ...
        <div class="brand-product-stage" aria-label="CELLEXOR Re:Tone product visual">
          <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/products/cellexor-re-tone.webp'); ?>" alt="CELLEXOR Re:Tone product">
          <span>Cell + Elixir</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section alt">
    <div class="container">
      ...
      <div class="grid grid-4">
        ...
        <article class="brand-panel brand-key"><span>02</span><p class="card-meta">Science</p><h3>Careful beauty language</h3><p>Exosome and NAD+ are presented as concept ingredients, not as promised medical outcomes.</p></article>
  ...
  <section class="brand-dark-section">
    <div class="container grid grid-2">
      <div>
        <p class="eyebrow">Core technology expression</p>
        <h2>Exosome + NAD+ inspired brand storytelling</h2>
        <p>For MEDIVISTA, the CELLEXOR concept is framed as advanced beauty science for professional aesthetic care. This keeps the premium feeling of the source brand while staying clear of unsupported performance language.</p>
      </div>
      <div class="brand-formula">
        <div><strong>V1</strong><span>Exosome-inspired powder concept</span></div>
        <div><strong>V2</strong><span>NAD+ activator concept</span></div>
        <div><strong>Re:Tone</strong><span>Professional product review path</span></div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="section-head">
        <div>
          <p class="eyebrow">Brand page flow</p>
          <h2>From brand mood to partner action</h2>
        </div>
        <p>The page is prepared for direct WordPress use and can later be expanded with approved CELLEXOR imagery, scroll motion, and translated Korean support.</p>
      </div>
      <div class="grid grid-3">
        ...
        <article class="info-card"><p class="card-meta">Product Philosophy</p><h3>Designed for Re:Tone review</h3><p>Product communication focuses on formula concept, presentation, and partner inquiry without price or transaction flow.</p></article>
