...
get_header();
?>
<main id="main-content" class="rumines-page">
  ...
  <section class="section rumines-preview">
    <div class="container grid grid-3">
      <article><span>01</span><h2>Quiet Luxury</h2><p>A restrained visual identity designed to feel timeless, bright, and premium.</p></article>
      <article><span>02</span><h2>Modern Radiance</h2><p>A beauty direction inspired by clarity, light, and confident professional presentation.</p></article>
      <article><span>03</span><h2>Global Reveal</h2><p>Brand story, product concept, and launch information will be introduced in stages.</p></article>
    </div>
  </section>
</main>
<?php get_footer(); ?>
