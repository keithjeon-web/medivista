...
Generated: 2026-06-21 12:15:46 +09:00
...
| 3 | GitHub Pages push | WARN | Deploy checkout status:<br>## feature/products-image-only-taxonomy...origin/feature/products-image-only-taxonomy<br> M about/index.html<br> M assets/css/styles.css<br> M docs/dev-log.md<br> M routine/issue-log.md<br> M wp-theme-starter/assets/css/main.css<br> M wp-theme-starter/functions.php<br> M wp-theme-starter/page-about.php<br>?? docs/about-page-audit.md<br>?? docs/qa-screenshots/about-medivista-1440.png<br>?? docs/qa-screenshots/about-medivista-390.png | Push automation is prepared but not executed without -PushDeploy. | Use git -c safe.directory="E:\엠플롯\컨설팅\왕자열\New project\.deploy-medivista-github" -C "E:\엠플롯\컨설팅\왕자열\New project\.deploy-medivista-github" push origin gh-pages from a network-enabled environment. |
