...
Generated: 2026-06-11 23:45:11 +09:00
...
| 3 | GitHub Pages push | WARN | Deploy checkout status:<br>## gh-pages...origin/gh-pages [ahead 11]<br> M about/index.html<br> M assets/data/medivista-products.csv<br> M assets/data/product-image-manifest.csv<br> M blogs/index.html<br> M brands/index.html<br> M cellexor/index.html<br> M contact/index.html<br> M dist/medivista-wp-network-themes-20260525.zip<br> M dist/medivista-wp-theme-starter-20260511-wp.zip<br> M docs/dev-log.md<br> M docs/error-report-latest.md<br> M index.html<br> M products/index.html<br> M wp-theme-starter/assets/data/medivista-products.csv<br> M wp-theme-starter/assets/data/product-image-manifest.csv<br> M wp-theme-starter/functions.php<br> M wp-theme-starter/header.php<br> M wp-theme-starter/template-parts/product-card.php<br>?? assets/data/product-category-classification.csv<br>?? wp-theme-starter/assets/data/product-category-classification.csv | Push automation is prepared but not executed without -PushDeploy. | Use git -c safe.directory="C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" -C "C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" push origin gh-pages from a network-enabled environment. |
| 4 | Public preview parity | WARN | Public preview (20260611d): Fetch failed. 원격 서버에 연결할 수 없습니다. | Verify after successful gh-pages push from a network-enabled environment. | Confirm logo, navigation, subpages, and mobile Global Reach. |
