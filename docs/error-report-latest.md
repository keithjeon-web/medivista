...
Generated: 2026-06-06 12:26:26 +09:00
...
| 3 | GitHub Pages push | WARN | fatal: unable to access 'https://github.com/keithjeon-web/medivista.git/': Failed to connect to github.com port 443 after 85 ms: Could not connect to server | Push failed; likely network/auth environment issue. | Use git -c safe.directory="C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" -C "C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" push origin gh-pages from a network-enabled environment. |
| 4 | Public preview parity | WARN | Public preview (20260606a): Fetch failed. 원격 서버에 연결할 수 없습니다. | Verify after successful gh-pages push from a network-enabled environment. | Confirm logo, navigation, subpages, and mobile Global Reach. |
