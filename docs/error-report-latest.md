...
Generated: 2026-06-11 23:07:06 +09:00
...
| 3 | GitHub Pages push | WARN | Deploy checkout status:<br>## gh-pages...origin/gh-pages [ahead 9] | Push automation is prepared but not executed without -PushDeploy. | Use git -c safe.directory="C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" -C "C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" push origin gh-pages from a network-enabled environment. |
| 4 | Public preview parity | WARN | Public preview (20260611b): Fetch failed. 원격 서버에 연결할 수 없습니다. | Verify after successful gh-pages push from a network-enabled environment. | Confirm logo, navigation, subpages, and mobile Global Reach. |
