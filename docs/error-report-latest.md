...
Generated: 2026-06-11 20:50:19 +09:00
...
| 3 | GitHub Pages push | WARN | fatal: unable to access 'https://github.com/keithjeon-web/medivista.git/': Failed to connect to github.com port 443 after 167 ms: Could not connect to server | Push failed; likely network/auth environment issue. | Use git -c safe.directory="C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" -C "C:\Users\jhj13\OneDrive\문서\New project\.deploy-medivista-github" push origin gh-pages from a network-enabled environment. |
